...
const livrosDestaque = [
  { id: 1, nome: "Dom Casmurro", descricao: "Um clássico da literatura brasileira sobre amor e ciúme.", nota: 5 },
  { id: 2, nome: "Harry Potter", descricao: "A jornada mágica de um jovem bruxo contra o mal.", nota: 4 },
  { id: 3, nome: "A Revolução dos Bichos", descricao: "Uma crítica poderosa sobre o totalitarismo.", nota: 4.5 },
  { id: 4, nome: "1984", descricao: "Um futuro sombrio controlado pelo Grande Irmão.", nota: 3 },
];
        ...
        <section className="carrossel">
          <div className="carrossel-container">
            ...
            <div className="bolinhas">
              <span className="bolinha ativa" onClick={() => irParaSlide(0)}></span>
              <span className="bolinha" onClick={() => irParaSlide(1)}></span>
              <span className="bolinha" onClick={() => irParaSlide(2)}></span>
            </div>
          </div>
