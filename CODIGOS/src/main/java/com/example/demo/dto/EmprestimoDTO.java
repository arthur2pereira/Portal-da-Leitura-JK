...
public class EmprestimoDTO {
    ...
    public EmprestimoDTO(Long emprestimoId, String matricula, String nome, String titulo, Long livroId, Long bibliotecarioId, LocalDate dataEmprestimo, LocalDate dataVencimento, LocalDate dataDevolucao, int renovacoes, String status) {
