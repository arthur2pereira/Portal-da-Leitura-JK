...
public class ReservaService {
    ...
    public EmprestimoModel transformarReservaEmEmprestimo(Long reservaId) {
        ReservaModel reserva = reservaRepository.findByReservaId(reservaId)
                .orElseThrow(() -> new RuntimeException("Reserva não encontrada."));
        ...
        Long bibliotecarioId = Long.parseLong(authentication.getName());

        BibliotecarioModel bibliotecario = bibliotecarioRepository.findByBibliotecarioId(bibliotecarioId)
